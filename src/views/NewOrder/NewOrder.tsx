...
export const NewOrder = () => {
    ...
    const { 
        location: { 
            ...
            } = { orderType: null, data: null, associations: [{...blankAssociation}] } 
        }
    } = history;

    const [data, setData] = useState<OrderData>(preData || blankData);
    const [associations, setAssociations] = useState<Associations>(preAssocations || [{...blankAssociation}]);
    const [orderTypes, setOrderTypes] = useState<OrderType>(orderType || blankOrderType);
    ...
    const stepComponents = [{
        ...
        component: <Step2 {...{setData}} {...{setAssociations}} {...{associations}} {...{orderTypes}} {...{data}} />,
    }, {
        label: 'Confirm Order',
        component: <Step3 {...{data}} orderType={orderTypes} />,
    }]

    return <FullScreenCreate 
                cancelPath="/" {...{stepComponents}} 
                activeStep={step} 

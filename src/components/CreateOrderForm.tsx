...
export const CreateOrderForm = ({basePath, setData, setAssociations, associations, orderTypes, data}: Props) => {
        ...
        <>
            ...
            <Grid item container spacing={2}>
                {orderTypes.estoppelLetter && (
                    <Grid item container spacing={2} xs={12} md={orderTypes.landSurvey ? 6 : 12} direction="column" >
